...
def get_histograms_for_dataset(dataset):
    ...
    noise_histograms = [
        ...
        OverlayHistogram('rechitEnergies', r'Rechit Energy (GeV)', 'Counts', root_histo_names=['initialRechitEnergies', 'mergedRechitEnergies'], logscale=True, vmin=1e0, vmax=1e6),
    ]
